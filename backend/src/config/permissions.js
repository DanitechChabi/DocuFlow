...
const CATALOGUE = [
  ...
  },
  {
    ...
    permissions: [
      ...
      { key: 'folders.manage_permissions', label: 'Administrer les périmètres', description: 'Définir qui peut consulter ou modifier chaque dossier (ACL par dossier, héritées du sous-arbre).' },
    ],
  },
  {
    module: 'search',
